...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=7");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body" >
                    <img src="../esculturas/Torso/esencia-masculina-bronce.jpg" class="card-img-top">
                        <br>
                        <h4 >Esencia Maculina Bronce</h4>
                        <p>
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_EsenMas.php" method="post">
                ...
                <div class="row no-gutters mt-5">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <a href="../esculturas/Torso/esencia-masculina-bronce.jpg" class="image-popup gal-item"><img src="../esculturas/Torso/esencia-masculina-bronce.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <a href="../esculturas/Torso/esencia-masculina-bronce (1).jpg" class="image-popup gal-item"><img src="../esculturas/Torso/esencia-masculina-bronce (1).jpg" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
