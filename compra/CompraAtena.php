...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=1");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                   ...
                   <div class="card-body" >
                       <img src="../esculturas/Torso/il_794xN.1263826342_163n.jpg" class="card-img-top">
                       <br>
                       <h4 >Esencia de atena</h4>
                       <p>
                      ...
                      <div class="row mb-5">
                          ...
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                            ...
                            <strong class="d-block">Carton</strong>
                          </div>
                        </div>
                        <h2 class="h4 text-black">Mas Información</h2>
                        <p>La escultura está realizada con papel carton diseñada en partes para su modelado.</p>
                        <br>
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_Atena.php" method="post">
                ...
                <div class="row no-gutters mt-5">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../esculturas/Torso/il_794xN.1263826342_163n.jpg" class="image-popup gal-item"><img src="../esculturas/Torso/il_794xN.1263826342_163n.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../esculturas/Torso/il_794xN.1263826416_dokt.jpg" class="image-popup gal-item"><img src="../esculturas/Torso/il_794xN.1263826416_dokt.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../esculturas/Torso/il_794xN.2095397971_gr9y.jpg" class="image-popup gal-item"><img src="../esculturas/Torso/il_794xN.2095397971_gr9y.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
