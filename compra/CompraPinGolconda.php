...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=22");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body" >
                    <img src="../pinturas/subrealismo/1.png" class="card-img-top">
                        <br>
                        <h4 >Golconda </h4>
                        <p>
                      ...
                      <div class="row mb-5">
                        ...
                        <p>Muestra un edificio estilo belga, y los personajes están caracterizados claramente al modo que Magritte lucía en la vida real.</p>
                        <br>
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_PinGolconda.php" method="post">
                ...
                <div class="row no-gutters mt-5">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../pinturas/subrealismo/1.png" class="image-popup gal-item"><img src="../pinturas/subrealismo/1.png" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../pinturas/subrealismo/2.png" class="image-popup gal-item"><img src="../pinturas/subrealismo/2.png" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../pinturas/subrealismo/3.png" class="image-popup gal-item"><img src="../pinturas/subrealismo/3.png" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
