...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=6");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body" >
                    <img src="../esculturas/Torso/esencia-femenina-bronce.jpg" class="card-img-top">
                        <br>
                        <h4 >Esencia Femenina Bronce</h4>
                        <p>
                      ...
                      <div class="row mb-5">
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                            ...
                            <strong class="d-block">66 cm</strong>
                          </div>
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_EsenFem.php" method="post">
                ...
                <div class="col-12">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <a href="../esculturas/Torso/esencia-femenina-bronce.jpg" class="image-popup gal-item"><img src="../esculturas/Torso/esencia-femenina-bronce.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <a href="../esculturas/Torso/esencia-femenina-bronce (1).jpg" class="image-popup gal-item"><img src="../esculturas/Torso/esencia-femenina-bronce (1).jpg" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
