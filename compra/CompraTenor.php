...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=30");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body" >
                    <img src="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro (1).jpg" class="card-img-top">
                        <br>
                        <h4 >Tenor</h4>
                        <p>
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_Tenor.php" method="post">
                ...
                <div class="row no-gutters mt-5">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro.jpg" class="image-popup gal-item"><img src="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro (1).jpg" class="image-popup gal-item"><img src="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro (1).jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro (2).jpg" class="image-popup gal-item"><img src="../esculturas/Cubismo/escultura-arlequin-cubista-grande-en-bronce-oscuro (2).jpg" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
