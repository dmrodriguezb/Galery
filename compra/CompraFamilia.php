...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=9");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body" >
                    <img src="../esculturas/Otros/escultura-la-familia.jpg" class="card-img-top">
                        <br>
                        <h4 >La Familia</h4>
                        <p>
                      ...
                      <div class="row mb-5">
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                            ...
                            <strong class="d-block">28 cm</strong>
                          </div>
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                          ...
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                            ...
                            <strong class="d-block">3.1 kg</strong>
                          </div>
                          <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_Familia.php" method="post">
                ...
                <div class="row no-gutters mt-5">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <a href="../esculturas/Otros/escultura-la-familia.jpg" class="image-popup gal-item"><img src="../esculturas/Otros/escultura-la-familia.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                   <div class="col-sm-6 col-md-6 col-lg-6">
                    <a href="../esculturas/Otros/escultura-la-familia (1).jpg" class="image-popup gal-item"><img src="../esculturas/Otros/escultura-la-familia (1).jpg" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
