...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT id, nombre, precio FROM productos where id=20");
            ...
            <div class="col-lg-12" align="center">
              <div>
                  ...
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body" >
                    <img src="../pinturas/realismo/1.png" class="card-img-top">
                        <br>
                        <h4 >Las espigadoras </h4>
                        <p>
                      ...
                      <div class="row mb-5">
                        ...
                        <p>Representa a tres campesinas recogiendo espigas bajo el sol.</p>
                        <br>
                    ...
                    <?php } else { ?>
                        <form action="agregar_al_carrito_PinEspigadoras.php" method="post">
                ...
                <div class="row no-gutters mt-5">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../pinturas/realismo/1.png" class="image-popup gal-item"><img src="../pinturas/realismo/1.png" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../pinturas/realismo/2.png" class="image-popup gal-item"><img src="../pinturas/realismo/2.png" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <a href="../pinturas/realismo/3.png" class="image-popup gal-item"><img src="../pinturas/realismo/3.png" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
                <br>
              </div>
